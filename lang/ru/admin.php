...
return [
    ...
    'dashboard' => [
        ...
        'chart_total' => 'Всего за 30 дней',
        'chart_avg' => 'В среднем в день',
        'chart_peak' => 'Пик за день',
    ...
    'news' => [
        ...
        'translation_hint' => 'Заполните хотя бы один язык полностью (заголовок, краткое описание и содержание). Остальные необязательны.',
        'translation_required' => 'Заполните хотя бы один язык полностью: заголовок, краткое описание и содержание.',
    ],
